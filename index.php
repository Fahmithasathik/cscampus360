      ...
      <div class="row">
		...
		@$page=  $_GET['page'];
          ...
          <div class="row placeholders">
            ...
            <a href="index.php?page=update_password">  <img src="images\pwd.png" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
             </a> <h4>Update Password</h4>
              
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
               <a href="index.php?page=manage_users"><img src="images\users.jpg" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Manage Users</h4>
             
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
             <a href="index.php?page=notification"> <img src="images\notify.jpg" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
